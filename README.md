...
- [Installation Guide](#installation-guide)
  ...
  - [Phase 2: Network Layer](#phase-2-network-layer)
  - [Phase 3: Load Balancing](#phase-3-load-balancing)
  - [Phase 4: Ingress Controller](#phase-4-ingress-controller)
  - [Phase 5: Package Manager](#phase-5-package-manager)
  - [Phase 6: Worker Node Setup](#phase-6-worker-node-setup)
